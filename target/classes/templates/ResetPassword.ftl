    ...
    <div class="log-form">
        <form  method="post">
            ...
            <div style="display: flex; align-items: center; justify-content: center;">
                <i style="font-size: 60px;" class="fas fa-key"></i>
            </div>
            <br>
            ...
            <div style="display: flex; align-items: center; justify-content: center;">
                <button type="submit" class="btn btn-primary" style="background-color: #099cec; border-color: #099cec; width: 150px; "><b style="font-size: 16;">Continue</b></button>
            </div>
        </form>
    </div>
</div>
