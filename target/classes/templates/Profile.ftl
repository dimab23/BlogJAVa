...
<@c.page>
    <title xmlns="http://www.w3.org/1999/html">${users.first_name}  ${users.last_name}</title>
            ...
            <span class="navbar-text" style="margin-right: 20%!important;">
                  <div class="btn-group">
                        ...
                        <div class="dropdown-menu" style="width: 190px;right: 0%; margin-left: auto; margin-right: auto; margin-top: 4px!important; width: 190px; right: 0; position: absolute; box-shadow: 0 2px 5px 0 rgba(0,0,0,.26);">
                            ...
                            <button type="button" data-toggle="modal" data-target="#exampleModalCenter2" class="dropdown-item" style="height: 28px; font-family: Open Sans,sans-serif; font-size: 14;">My Notification &nbsp;&nbsp; &nbsp;&nbsp;
    ...
    <div class="styles__profileHeader___niDUC">
        <div class="styles__header___2DnGz">
            <div class="styles__coverPhoto___1zsF0"></div>
            <p style="text-align: center; font-size: 12px; color:#ff860d;"> ${PasswordEroor?ifExists}</p>
            <p style="text-align: center; font-size: 12px; color:red;"> ${PasswordEroor1?ifExists}</p>
            <div class="styles__infoSection___1UTm3">
                <div class="styles__photoWrapper___3q6TR" data-testid="profileAvatar">
                    <div class="styles__parent___2mFTP styles__default___3Uxzu"><img data-testid="imgSource" alt="Avatar" src="https://d36jcksde1wxzq.cloudfront.net/saas-mega/blueFingerprint.png" height="80px">
                    </div>
                </div>
                <div class="styles__info___1Rd2O">
                    <div data-testid="profileName" class="styles__name___14uxE">
                       ${users.first_name}  &nbsp; ${users.last_name}
                        <span>
                            <button type="submit" data-toggle="modal" data-target="#exampleModalCenter1" class="styles__editLink___3a5pj"><b style="color: #445d6e;">Edit profile <i class="fas fa-user-edit"></i> &nbsp;&nbsp;</b>
                        </button>
                        </span>
                    </div>
                    <div class="styles__details___3dj2a">
                        <div class="styles__description___2DIwK">

                        </div>
                        <div class="styles__details___3dj2a" data-testid="profileDetails" style="margin-top: 4%;">
                            <div class="styles__detail___1k4W1"><i class="fas fa-user"></i> &nbsp; Community User</div>
                            <div class="styles__detail___1k4W1"><i class="far fa-clock"></i> &nbsp; Joined ${users.date}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div data-testid="profileTab" class="styles__tabsSection___1D23b">
            <div class="styles__tabs___2SA5L">
                <a class="styles__tab___z1vFX styles__selected___22RAS" data-testid="testTabName" href="/my_profile">My Articles</a>
            </div>
        </div>
    <#if countArticles == 0>
        <div class="styles__container___1hTq9 styles__empty___2NhPc">
                    <img  src="https://img.icons8.com/wired/100/000000/broken-link.png">
            <div class="styles__title___1c5lz">No repositories</div>
            <div class="styles__subtitle___LAFLH">You have not created any article</div>
        </div>
    <#else>
        ...
        <div class="styles__homeWelcome___znAUb styles__home___y_Nj1">
            <div class="wrapped">
                <div class="styles__welcomeBox___5mYOc" style="margin-top: 3%!important; margin-bottom: 3%!important;max-width: calc(100% - 24px); margin: auto; box-shadow: 0 1px 2px #c2c2c2!important;">
                    ...
                    <div style="padding-top: 60px; padding-bottom: 30px; font-size: 16px;"><i>- Author</i> ${article.users.first_name}  ${article.users.last_name}</div>
                    <div style="font-size: 44px; line-height: 46px; padding-bottom: 20px;"><a class="nav-link" style="color: white;" href="articles/${article.id}">${article.title}</a></div>
                    <div style="font-size: 12px; font-weight: 500; padding-bottom: 40px;">${article.content}</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <input type="password" class="form-control" name="password_current"  placeholder="Enter Password Curent" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <input type="password" class="form-control" name="password"  placeholder="Enter Password New" required>
                        </div>
                    </div>
                </div>
